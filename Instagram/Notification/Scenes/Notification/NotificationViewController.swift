...
extension NotificationViewController: PagingViewControllerDataSource {
    ...
    func pagingViewController<T>(_ pagingViewController: PagingViewController<T>, viewControllerForIndex index: Int) -> UIViewController {
        ...
        case Page.followingActivities:
            ...
            let viewController = storyboard.instantiateViewController(withIdentifier: "FollowingTableViewController") as! NotificationFollowingActivityTableViewController
        ...
        case Page.notification:
            let storyboard = UIStoryboard.init(name: "Notification", bundle: nil)
            let viewController = storyboard.instantiateViewController(withIdentifier: "NotificationTableViewController") as! NotificationYouActivityTableViewController
